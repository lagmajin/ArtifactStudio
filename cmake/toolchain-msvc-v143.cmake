...
if(_v143_found_cl)
    ...
    if(_v143_windows_sdk_include_versions)
        ...
        if(EXISTS "${_v143_msvc_root}/include" AND EXISTS "${_v143_windows_sdk_ucrt_include}")
            set(ENV{INCLUDE}
                "${_v143_msvc_root}/include;${_v143_msvc_root}/atlmfc/include;${_v143_windows_sdk_ucrt_include};${_v143_windows_sdk_shared_include};${_v143_windows_sdk_um_include};${_v143_windows_sdk_winrt_include};$ENV{INCLUDE}")

            set(CMAKE_C_FLAGS_INIT
                "${CMAKE_C_FLAGS_INIT} /I\"${_v143_msvc_root}/include\" /I\"${_v143_msvc_root}/atlmfc/include\" /I\"${_v143_windows_sdk_ucrt_include}\" /I\"${_v143_windows_sdk_shared_include}\" /I\"${_v143_windows_sdk_um_include}\" /I\"${_v143_windows_sdk_winrt_include}\""
            )
            set(CMAKE_CXX_FLAGS_INIT
                "${CMAKE_CXX_FLAGS_INIT} /I\"${_v143_msvc_root}/include\" /I\"${_v143_msvc_root}/atlmfc/include\" /I\"${_v143_windows_sdk_ucrt_include}\" /I\"${_v143_windows_sdk_shared_include}\" /I\"${_v143_windows_sdk_um_include}\" /I\"${_v143_windows_sdk_winrt_include}\""
            )
        endif()
        if(EXISTS "${_v143_msvc_lib_dir}" AND EXISTS "${_v143_windows_sdk_ucrt_lib}" AND EXISTS "${_v143_windows_sdk_um_lib}")
            set(ENV{LIB}
                "${_v143_msvc_lib_dir};${_v143_msvc_atlmfc_lib_dir};${_v143_windows_sdk_ucrt_lib};${_v143_windows_sdk_um_lib};$ENV{LIB}")

            set(CMAKE_EXE_LINKER_FLAGS_INIT
                "${CMAKE_EXE_LINKER_FLAGS_INIT} /LIBPATH:\"${_v143_msvc_lib_dir}\" /LIBPATH:\"${_v143_msvc_atlmfc_lib_dir}\" /LIBPATH:\"${_v143_windows_sdk_ucrt_lib}\" /LIBPATH:\"${_v143_windows_sdk_um_lib}\""
            )
            set(CMAKE_SHARED_LINKER_FLAGS_INIT
                "${CMAKE_SHARED_LINKER_FLAGS_INIT} /LIBPATH:\"${_v143_msvc_lib_dir}\" /LIBPATH:\"${_v143_msvc_atlmfc_lib_dir}\" /LIBPATH:\"${_v143_windows_sdk_ucrt_lib}\" /LIBPATH:\"${_v143_windows_sdk_um_lib}\""
            )
            set(CMAKE_MODULE_LINKER_FLAGS_INIT
                "${CMAKE_MODULE_LINKER_FLAGS_INIT} /LIBPATH:\"${_v143_msvc_lib_dir}\" /LIBPATH:\"${_v143_msvc_atlmfc_lib_dir}\" /LIBPATH:\"${_v143_windows_sdk_ucrt_lib}\" /LIBPATH:\"${_v143_windows_sdk_um_lib}\""
            )
        endif()
    endif()
endif()
