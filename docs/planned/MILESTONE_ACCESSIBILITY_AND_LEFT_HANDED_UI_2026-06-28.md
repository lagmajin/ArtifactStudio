...
### Phase 1 の完了条件
- 利き手設定を保存できる
- いくつかの主要 widget がその設定を読める
- 左利き向け補助の有効/無効を切り替えられる
- 既存 UI の挙動を壊さずに 1 つ以上の補助が入っている
...
### Phase 2 の完了条件
- 主要 widget の一部で、利き手に応じた配置や補助が反映される
- 視認性補助が少なくとも 1 つ以上の UI に適用される
- 左利き向けと障碍者向けの共通・個別が整理される
