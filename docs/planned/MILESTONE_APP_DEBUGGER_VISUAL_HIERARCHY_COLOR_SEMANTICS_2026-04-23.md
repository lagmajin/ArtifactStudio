...
5. focus / pin / filter を固定する
6. report / share bundle を固定する
7. legend / semantic key を固定する
8. quick actions を固定する
9. auto focus / smart ranking を固定する
10. session history / comparison を固定する
11. render cost breakdown を固定する
