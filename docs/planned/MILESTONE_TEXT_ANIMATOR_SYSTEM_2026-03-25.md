...
## Progress 2026-08-24: selector set 構造化（タプル撤去の第一歩）

- `Text.Animator` に `SelectorCombineMode`（Multiply/Add/Subtract/Min/Max）と `AnimatorSelectorSet`（名前付きセレクター群 + combine モード）を追加。
