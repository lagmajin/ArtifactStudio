...
- 2026-03-27 時点で、`ArtifactTimelineTrackPainterView` に selected layer の keyframe marker を重ね描きし、visibility の入口を作り始めた
- 2026-03-27 時点で、Timeline の right-click menu から selected layer / clip layer の keyframe を playhead 位置で追加・削除できるようにした
- 2026-03-27 時点で、keyframe marker を左クリックするとその frame へ seek できるようにした
- 2026-03-28 時点で、timeline header 側に検索・モード・件数表示を寄せる土台ができたので、keyframe の前後ジャンプや診断表示を Phase 6 としてまとめやすくなった
