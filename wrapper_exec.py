#!/usr/bin/env python3
"""
Wrapper: Import and execute fix_nonwidget_gmf directly
"""
import sys
import os
...
# Import the components we need from the fix script
import re

# Copy the function and main logic from fix_nonwidget_gmf.py
